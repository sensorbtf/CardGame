...
public class TableVisual : MonoBehaviour 
{
    ...
    void ShiftSlotsGameObjectAccordingToNumberOfCreatures()
    {
        ...
        if (CreaturesOnTable.Count > 0)
        {
            ...
            posY = (slots.Children[0].transform.localPosition.y - slots.Children[CreaturesOnTable.Count - 1].transform.localPosition.y) / 2f;
        }
        else
        {
            posX = 0f;
        ...
        slots.gameObject.transform.DOLocalMoveY(posY, 0.3f);
    }
    ...
    void PlaceCreaturesOnNewSlots()
    {
        foreach (GameObject g in CreaturesOnTable)
        {
            ...
            g.transform.DOLocalMoveY(slots.Children[CreaturesOnTable.IndexOf(g)].transform.localPosition.y, 0.3f);
